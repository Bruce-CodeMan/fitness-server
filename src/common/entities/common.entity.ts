/*
 * @Date: 2023-04-17 10:32:08
 * @Author: Bruce
 * @Description: 
 */
import { validateOrReject, IsDate, IsOptional } from "class-validator";
import { BeforeInsert, BeforeUpdate, Column, PrimaryGeneratedColumn, DeleteDateColumn } from "typeorm";
...
export class CommonEntity {
    ...
    @Column({ comment: "修改时间", type: "timestamp", nullable: true })
    updatedAt: Date;
    ...
    @Column({ comment: "删除者", nullable: true })
    @IsOptional()
    deletedBy: string;
